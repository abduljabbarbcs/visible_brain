...
import com.visiblebrain.backend.service.user.MailService;
...
public class UserController {
    ...
    @RequestMapping(value = "/user/reset-password-login")
    public String resetPasswordEmailPostLogin(User user,Model model) {
