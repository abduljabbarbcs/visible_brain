package com.visiblebrain.backend.service.user;
...
import com.visiblebrain.backend.App;
...
public class UserService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        if(requireActivation && !user.getToken().equals("1")) {
            App.log.error("User [" + username + "] tried to login but is not activated");
    ...
    public User register(User user) {
        ...
        if (this.repo.findOneByUserName(user.getUserName()) == null && this.repo.findOneByEmail(user.getEmail()) == null && user.getFirstName()!=null && user.getEmail() !=null ) {
